...
from dmaa.constants import (
    DMAA_STACK_NOT_EXISTS_STATUS,
    DMAA_STACK_NOT_WORKING_STATUS,
    DMAA_STACK_OK_STATUS,
    ENV_STACK_NAME,
    MODEL_STACK_NAME_PREFIX,
    STACK_COMPLATE_STATUS_LIST,
)
from dmaa.models import Service, Model
from dmaa.models.utils.constants import (
    InstanceType,
    ServiceCode,
    ServiceQuotaCode,
)
from dmaa.utils.exceptions import EnvStackNotExistError
...
class StackStatus:
    ...
    @property
    def status(self):
        return self.status_info.get("StackStatus", DMAA_STACK_NOT_EXISTS_STATUS)
