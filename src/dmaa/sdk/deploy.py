...
from dmaa.models.utils.serialize_utils import dump_extra_params
from dmaa.utils.aws_service_utils import (
    check_cn_region,
...
from dmaa.utils.upload_pipeline import ziped_pipeline
...
def deploy(
    ...
    bucket_name = get_bucket_name(
        bucket_prefix="dmaa-env-artifactbucket", region=region
    )
...
def deploy_local(
    ...
    # model_stack_name=None,
    extra_params=None,
    pipeline_zip_local_path=f"/tmp/dmaa_{VERSION}/pipeline.zip",
    # env_stack_on_failure = "ROLLBACK",
    # force_env_stack_update = False,
    # waiting_until_deploy_complete = True
) -> dict:
