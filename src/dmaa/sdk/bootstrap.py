...
from dmaa.utils.upload_pipeline import upload_pipeline_source_to_s3,dmaa_package_dir
...
def get_bucket_name(
        bucket_prefix="dmaa-env-artifactbucket",
        region=None
    ):
    """
    get bucket name
...
def create_env_stack(
    ...
    Args:
        ...
        bucket_prefix (str, optional): _description_. Defaults to "dmaa-env-artifactbucket".
