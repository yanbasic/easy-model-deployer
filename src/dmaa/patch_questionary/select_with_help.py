...
from dmaa.patch_questionary import common_with_help
from dmaa.patch_questionary.common_with_help import Choice
from dmaa.patch_questionary.common_with_help import InquirerControl
from dmaa.patch_questionary.common_with_help import Separator
from questionary.question import Question
from questionary.styles import merge_styles_default


def select_with_help(
    message: str,
    ...
    **kwargs: Any,
    ...
    layout = common_with_help.create_inquirer_layout(ic, get_prompt_tokens, **kwargs)
