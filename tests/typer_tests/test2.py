...
from typing import Sequence,Callable,Mapping,Pattern,Iterable
...
# 创建一个 WordCompleter 实例，支持过滤
completer = WordCompleter(options, ignore_case=True,match_middle=True)

# 提示用户输入
user_input = prompt("请选择水果（输入部分关键字进行过滤）: ", completer=completer)

print(f"你选择的水果是: {user_input}")
